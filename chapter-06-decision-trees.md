...
### Information Gain
```
IG(S, feature) = H(S) - Σ_split (|S_split|/|S|) · H(S_split)
```
...
3. Implement **cost-complexity pruning** (reduce tree size using a complexity parameter α).
4. Visualize information gain vs threshold for a single feature split.

---

**← Previous:** [Chapter 05: Naive Bayes](chapter-05-naive-bayes.md)  
**→ Next:** [Chapter 07: Support Vector Machines](chapter-07-svm.md)
